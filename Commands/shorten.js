...
module.exports = {
    ...
    async execute(interaction) {
        ...
        // Check if bot has required permissions (EmbedLinks and SendMessages)
        const botPermissions = interaction.guild.members.me.permissions;
        if (!botPermissions.has(PermissionFlagsBits.EmbedLinks) || !botPermissions.has(PermissionFlagsBits.SendMessages)) {
            return await interaction.reply({
                content: '❌ I need "Embed Links" and "Send Messages" permissions to execute this command.',
                ephemeral: true
            });
        }
